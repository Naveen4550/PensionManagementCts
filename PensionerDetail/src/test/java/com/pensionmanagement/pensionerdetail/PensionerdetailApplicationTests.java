...
public class PensionerdetailApplicationTests {
	...
	public void testController() throws Exception {
		...
		when(pensionerDetailService.getPensionerDetails(172666093381l)).thenReturn(detail);
		mockMvc.perform(get("/PensionerDetailByAadhaar?aadhaarNumber=172666093381").header("Authorization", "token"))
				.andExpect(status().isOk());
		verify(controller, timeout(1)).pensionerDetailByAadhaar("token", 172666093381l);
	}
	...
	public void TestPensionerDetails() throws Exception {
		...
		pensionerDetail1 = pensionerDetailRepositoryImpl.getPensionerDetails(172666093381l);
