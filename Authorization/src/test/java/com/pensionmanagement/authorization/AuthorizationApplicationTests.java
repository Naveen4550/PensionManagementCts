...
public class AuthorizationApplicationTests {
	...
	public void login() throws JsonProcessingException, Exception {
		UserModel menu = new UserModel("Naveen", "password1");
	...
	public void testIsTokenExpiredOrInvalidFormat_validToken() {
		userDetails = jwtInMemoryUserDetailsService.loadUserByUsername("Naveen");
		userRepository.findByUsername("Naveen");
	...
	public void testJwtRequest() {
		jwtRequest = new JwtRequest("Naveen", "Password");
		...
		userModel = new UserModel("Naveen", "Password");
	...
	public void testJwtAuthenticationController() throws Exception {
		loginService.authenticate("Naveen", "password1");
		log.info("Authentication tested");
	}
